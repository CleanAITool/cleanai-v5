...
def main():
    ...
    # Save pruned model
    pruned_checkpoint_path = CHECKPOINT_DIR / f"{MODEL_NAME}_{DATASET_NAME}_pruned_W.pth"
    torch.save({
    ...
    # Save final model
    final_checkpoint_path = CHECKPOINT_DIR / f"{MODEL_NAME}_{DATASET_NAME}_FTAP_W_final.pth"
    torch.save({
        'model_state_dict': pruned_model.state_dict(),
        'accuracy': final_accuracy['accuracy'],
        'method': 'WANDA',
