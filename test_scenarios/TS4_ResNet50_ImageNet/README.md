# Test Scenario TS4: ResNet-50 on ImageNet
...
- **Checkpoints**: `C:\source\checkpoints\TS4\`
...
## Scripts
1. **TS4_01_prepare_model.py**: Loads pretrained ResNet-50, evaluates on ImageNet validation
2. **TS4_02_coverage_pruning.py**: Applies Neuron Coverage pruning and fine-tunes
3. **TS4_03_wanda_pruning.py**: Applies Wanda pruning and fine-tunes
4. **TS4_04_magnitude_pruning.py**: Applies Magnitude-based pruning (Torch-Pruning baseline) and fine-tunes
5. **TS4_05_taylor_pruning.py**: Applies Taylor gradient-based pruning (Torch-Pruning) and fine-tunes
6. **TS4_compare_results.py**: Compares results from all methods
7. **TS4_run_all.py**: Runs all scripts in sequence
...
## Results
Results are saved to: `test_scenarios/TS4_ResNet50_ImageNet/TS4_Results.json`
