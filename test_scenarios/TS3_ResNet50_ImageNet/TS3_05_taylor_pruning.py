"""
Test Scenario TS3 - Script 5: Taylor Gradient-Based Pruning
...
CONFIG = {
    ...
    'method': 'TAY',  # Taylor
    'checkpoint_dir': r'C:\source\checkpoints\TS3',
    'dataset_dir': r'C:\source\downloaded_datasets\imagenet',
    'results_dir': os.path.join(os.path.dirname(__file__)),
    'results_file': 'TS3_Results.json',
...
def load_dataset():
    ...
    if not os.path.exists(val_dir):
        ...
        print("Please run TS3_01_prepare_model.py first to set up the dataset.")
...
def load_finetuned_model():
    ...
    if not os.path.exists(best_checkpoint):
        raise FileNotFoundError(f"Baseline model not found: {best_checkpoint}\n"
                              f"Please run TS3_01_prepare_model.py first.")
