"""
Test Scenario TS7 - Run All Scripts
...
CONFIG = {
    ...
    'scripts': [
        'TS7_01_prepare_model.py',
        'TS7_02_coverage_pruning.py',
        'TS7_03_wanda_pruning.py',
        'TS7_04_magnitude_pruning.py',
        'TS7_05_taylor_pruning.py',
        'TS7_compare_results.py'
    ]
}
