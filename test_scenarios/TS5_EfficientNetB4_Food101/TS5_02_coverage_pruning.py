"""
Test Scenario TS5 - Script 2: Neuron Coverage Pruning
Loads fine-tuned EfficientNet-B4, applies Neuron Coverage pruning, and fine-tunes the pruned model.
"""
...
CONFIG = {
    ...
    'checkpoint_dir': r'C:\source\checkpoints\TS5',
...
def load_dataset():
    ...
    try:
        ...
        print("Please run TS5_01_prepare_model.py first to set up the dataset.")
        raise
...
def load_finetuned_model():
    ...
    if not os.path.exists(best_checkpoint):
        raise FileNotFoundError(f"Baseline model not found: {best_checkpoint}\n"
                              f"Please run TS5_01_prepare_model.py first.")
...
def main():
    ...
    results = {
        ...
        'script': 'TS5_02_coverage_pruning',
        'pruning_config': {
