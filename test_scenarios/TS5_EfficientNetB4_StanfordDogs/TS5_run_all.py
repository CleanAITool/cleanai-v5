"""
Test Scenario TS5 - Run All Scripts
...
CONFIG = {
    ...
    'scripts': [
        'TS5_01_prepare_model.py',
        'TS5_02_coverage_pruning.py',
        'TS5_03_wanda_pruning.py',
        'TS5_04_magnitude_pruning.py',
        'TS5_05_taylor_pruning.py',
        'TS5_compare_results.py'
    ]
}
